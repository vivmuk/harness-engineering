  ...
  return (
    <footer className="border-t border-white/5 bg-surface">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-text">Harness Engineering</span>
            </Link>
          ...
          <div>
            <h3 className="font-medium text-text mb-3">Learn</h3>
          ...
          <div>
            <h3 className="font-medium text-text mb-3">Build</h3>
            <ul className="space-y-2 text-sm text-text-secondary">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-text-secondary">
          <p>© {new Date().getFullYear()} Harness Engineering. Open source under MIT.</p>
          <div className="flex items-center gap-4">
            <a href="https://github.com/vivmuk/harness-engineering" target="_blank" rel="noopener noreferrer" className="hover:text-text flex items-center gap-1">
              GitHub
            </a>
          </div>
        </div>
